...
class Loan(models.Model):
    ...
    fin_owns_home         = models.BooleanField()
    fin_bankruptcy        = models.BooleanField()
    fin_short_sale        = models.BooleanField()
    ...
    # Docs (Needs List)
    docs_executive_summary = models.BooleanField()
    docs_credit_report     = models.BooleanField()
    docs_personal_taxes    = models.BooleanField()
    docs_business_taxes    = models.BooleanField()
    docs_P_and_L           = models.BooleanField()
    docs_expense_report    = models.BooleanField()
    docs_brokers_opinion   = models.BooleanField()
    docs_appraisal         = models.BooleanField()
    docs_environmental     = models.BooleanField()
    docs_rent_roll         = models.BooleanField()
    docs_lease_agreements  = models.BooleanField()
...
class Lender(models.Model):
    ...
    # Owner Occupied
    oo_office        = models.BooleanField()
    oo_warehouse     = models.BooleanField()
    oo_manufacturing = models.BooleanField()
    oo_medical       = models.BooleanField()
    oo_mixed_use     = models.BooleanField()
    oo_other         = models.BooleanField()

    # Investment
    inv_office        = models.BooleanField()
    inv_warehouse     = models.BooleanField()
    inv_manufacturing = models.BooleanField()
    inv_medical       = models.BooleanField()
    inv_mixed_use     = models.BooleanField()
    inv_other         = models.BooleanField()
    ...
    # Construction
    constr_renovation     = models.BooleanField()
    constr_ground_up_spec = models.BooleanField()
    constr_commercial     = models.BooleanField()
    constr_residential    = models.BooleanField()
    constr_inv_with_land  = models.BooleanField()
    constr_oo_with_land   = models.BooleanField()

    # SBA
    sba_7a      = models.BooleanField()
    sba_504     = models.BooleanField()
    sba_CAPline = models.BooleanField()
    sba_micro   = models.BooleanField()
    sba_other   = models.BooleanField()
    ...
    # Qualifiers
    qual_pays_fees        = models.BooleanField()
    qual_outside_ca       = models.BooleanField()
    qual_1031_exchange    = models.BooleanField()
    qual_lt_500K          = models.BooleanField()
    qual_lt_1M            = models.BooleanField()
    qual_equip            = models.BooleanField()
    qual_non_conform      = models.BooleanField()
    qual_ground_lease     = models.BooleanField()
    qual_relationship     = models.BooleanField()
    qual_cannabis         = models.BooleanField()
    qual_io               = models.BooleanField()
    qual_rev_trust        = models.BooleanField()
    qual_irrev_trust      = models.BooleanField()
    qual_foreclosure      = models.BooleanField()
    qual_single_tenant    = models.BooleanField()
    qual_bk               = models.BooleanField()
    qual_entitlements     = models.BooleanField()
    qual_non_profit       = models.BooleanField()
    qual_cashout_refi     = models.BooleanField()
    qual_non_recourse     = models.BooleanField()
    qual_re_collateral    = models.BooleanField()
    qual_cross_collateral = models.BooleanField()
    qual_biz_acq          = models.BooleanField()

    prop_automotive      = models.BooleanField()
    prop_carwash         = models.BooleanField()
    prop_entertainment   = models.BooleanField()
    prop_farm            = models.BooleanField()
    prop_gas_station     = models.BooleanField()
    prop_hospital        = models.BooleanField()
    prop_hotel_flag      = models.BooleanField()
    prop_hotel_nonflag   = models.BooleanField()
    prop_industrial      = models.BooleanField()
    prop_marina          = models.BooleanField()
    prop_medical         = models.BooleanField()
    prop_mobile_home     = models.BooleanField()
    prop_motel_flag      = models.BooleanField()
    prop_motel_nonflag   = models.BooleanField()
    prop_multifamily     = models.BooleanField()
    prop_office          = models.BooleanField()
    prop_restaurant      = models.BooleanField()
    prop_retail          = models.BooleanField()
    prop_senior_housing  = models.BooleanField()
    prop_storage         = models.BooleanField()
    prop_student_housing = models.BooleanField()
